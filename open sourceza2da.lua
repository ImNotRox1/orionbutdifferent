...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "custom.lua"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "custom.lua"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			Name = "Script closed",
			Content = (isMobile and 'Click on the <b>Icon' or 'Press the key <b>' .. _currentKey.Name) .. "</b> to open the GUI again!",
			Time = 5
		})
